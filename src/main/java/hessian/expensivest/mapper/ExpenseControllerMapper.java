...
public class ExpenseControllerMapper {
    ...
    public List<Expense> category(@RequestParam String category) throws ParseException {
        return repository.findByCategory(anyParser.parse(category, String.class));
    }
    ...
    public List<Expense> categoryLike(@RequestParam String category) throws ParseException {
        return repository.findByCategoryLike(anyParser.parse(category, String.class));
    }
    ...
    public List<Expense> categoryStarts(@RequestParam String category) throws ParseException {
        return repository.findByCategoryStartingWith(anyParser.parse(category, String.class));
    }

    // Aggregates
    @RequestMapping(value = "dse/sum_count/global")
    public ExpenseRepositoryMapper.SumCount sumCountGlobal() {
        return repository.sumCountGlobal();
    }
    @RequestMapping(value = "dse/sum_count/user")
    public List<ExpenseRepositoryMapper.SumCount> sumCountByUser() {
        return repository.sumCountByUser();
    }

    @RequestMapping(value = "dse/sum_count/user_and_trip")
    public List<ExpenseRepositoryMapper.SumCount> sumCountByUserAndTrip() {
